...
const Post = ({ data, user }) => {
  ...
  const [showShareButtonAnimation, setShowShareButtonAnimation] = useState(false);
  ...
  // useEffect(() => {
    // console.log(data.userId[1].profilePicture);
  // }, [data]);
  ...
  const handleLike = async () => {
    ...
    // console.log(data._id); post_id
    if (!liked) { // Check if the post is being liked (not unliked)
  ...
  const toggleShareModal = () => {
    ...
    setShowShareButtonAnimation(true);
    setIsAnimating(true);

    setTimeout(() => {
      setShowShareButtonAnimation(false);
      ...
      <div className="Post">
        <div className="postHead">
          <div className="userProfile">
            <img
              src={
                data.userId[1].profilePicture
                  ? serverPublic + data.userId[1].profilePicture
        ...
        <div className="postReact">
          ...
          <img
            ...
            className={`share-button ${isAnimating ? "share-animation" : ""}`}
          />
        </div>
